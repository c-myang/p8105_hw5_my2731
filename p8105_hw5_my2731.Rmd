...
Based on the plot, we can see that for samples where the null hypothesis was rejected, average $\hat{\mu}$̂ estimates across tests for which the null is rejected is much lower than the true value of $\mu$. This is in accordance to what we would expect, as estimated means which deviate substantially from the true mean will lead to a rejection of the null hypothesis.
