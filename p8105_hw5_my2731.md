...
```
    ...
    ##        <int>   <int>    <dbl>   <dbl> <chr>            
    ##  1         1       1   1.57    0.0885 Null not rejected
    ##  2         1       2   0.609   0.659  Null not rejected
    ##  3         1       3   0.641   0.426  Null not rejected
    ##  4         1       4   1.18    0.236  Null not rejected
    ##  5         1       5   0.0813  0.937  Null not rejected
    ##  6         1       6   0.468   0.532  Null not rejected
    ##  7         1       7   1.67    0.0150 Null rejected    
    ##  8         1       8   2.43    0.0122 Null rejected    
    ##  9         1       9   1.21    0.167  Null not rejected
    ## 10         1      10   1.72    0.0141 Null rejected    
