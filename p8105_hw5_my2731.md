...
```
    ...
    ##        <int>   <int>    <dbl>   <dbl> <chr>            
    ##  1         1       1   -0.264 0.803   Null not rejected
    ##  2         1       2    2.41  0.00752 Null rejected    
    ##  3         1       3    0.204 0.829   Null not rejected
    ##  4         1       4    1.65  0.0831  Null not rejected
    ##  5         1       5    1.01  0.410   Null not rejected
    ##  6         1       6   -0.453 0.634   Null not rejected
    ##  7         1       7    0.565 0.549   Null not rejected
    ##  8         1       8   -0.900 0.265   Null not rejected
    ##  9         1       9    2.00  0.0394  Null rejected    
    ## 10         1      10    1.39  0.146   Null not rejected
