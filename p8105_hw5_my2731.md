...
```
    ...
    ##        <int>   <int>    <dbl>   <dbl> <chr>            
    ##  1         1       1  -0.342   0.723  Null not rejected
    ##  2         1       2   2.29    0.0170 Null rejected    
    ##  3         1       3   1.11    0.348  Null not rejected
    ##  4         1       4   0.526   0.460  Null not rejected
    ##  5         1       5   1.58    0.0758 Null not rejected
    ##  6         1       6   1.05    0.297  Null not rejected
    ##  7         1       7  -0.0854  0.919  Null not rejected
    ##  8         1       8   1.41    0.169  Null not rejected
    ##  9         1       9   1.02    0.260  Null not rejected
    ## 10         1      10   2.01    0.0154 Null rejected    
